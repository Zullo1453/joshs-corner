...
def entry_integration_form(selected_date, journal_entry, submitted_form=None):
    ...
    if submitted_form is not None:
        return {
            ...
            "deadline_due_date": submitted_form.get("deadline_due_date", ""),
            ...
            "upcoming_event_date": submitted_form.get("upcoming_event_date", ""),
    ...
    return {
        ...
        "deadline_due_date": deadline.due_date.isoformat() if deadline is not None else "",
        ...
        "upcoming_event_date": upcoming.event_date.isoformat() if upcoming is not None else "",
